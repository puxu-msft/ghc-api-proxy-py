...
完整评审报告：`docs/tmp/260820-review-history-forensics-proposal.md`、`260820-review-history-forensics-scope.md`（r1 轮）、`260820-review-history-forensics-proposal-r2.md`、`260820-review-history-forensics-scope-r2.md`（r2 轮）、`260820-review-history-forensics-r3-spotcheck.md`（r3 抽查）。逐条处置见第七节。

### 证据基线与一个警告

三份只读调查：`docs/tmp/260820-history-wiring-audit.md`、`260820-forensic-demand-audit.md`、`260820-history-as-fixture-source.md`。
