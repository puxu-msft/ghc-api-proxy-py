...
权威是 [spec.md](spec.md) 的**当前版本**（它也是活文档，不冻结）。本台账不新增规范，只登记它排除或推迟的东西，使其不被静默删掉。**台账不得存放已知错误的 Spec 条款**——那属于当场修订 Spec，不属于登记待办；2026-08-24 的 E-9 就是按这条撤销并入 spec.md §6.2/§6.3 的。
