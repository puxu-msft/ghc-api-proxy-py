...
2. `config.example.yaml` 没有文档化 `auth_base_url`（该字段已实装且已列入不可热重载清单）。早前登记于 [260822-ghc-api-conformance-summary.md](history/260822-ghc-api-conformance-summary.md) 的 D2。
