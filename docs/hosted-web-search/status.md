...
- `strip_anthropic_beta_flags` —— 用户确认要实现，已落地：schema 建模、新链路接线、单元与端到端测试齐备。经过与未采纳项见 [实施记录](../anthropic-direct-request-shape/history/260822-beta-flag-strip-implementation.md)。
