...
**来源**：`archive-count-tokens-line/reports/260820-review-count-tokens-log-line.md` F6，以及更早的 `../count-tokens/reports/260820-review-count-tokens-shared-pipeline.md:72`（后者属另一切片，仍在主仓 `docs/tmp`）。
