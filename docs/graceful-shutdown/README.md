...
监听器那一半（socket activation、`SO_REUSEPORT` 平滑重启、代际生命周期）目前还散在 `../systemd-runtime/`、`../systemd-rolling/`、`../deployment-systemd/` 三个话题下，尚未并进来。（2026-08-21 之前它们在主仓库 `docs/agents/` 下。）
