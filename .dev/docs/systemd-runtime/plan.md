...
- `../archived-2604-rewrite/shutdown.md` 描述 `60s` graceful wait、`120s` abort wait 与四阶段设计，但旧设计文档不能证明生产已接线。
