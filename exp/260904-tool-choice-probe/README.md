...
```bash
PYTHONPATH=src uv run --frozen python .dev/exp/260904-tool-choice-probe/probe.py search
PYTHONPATH=src uv run --frozen python .dev/exp/260904-tool-choice-probe/probe.py anthropic
```
