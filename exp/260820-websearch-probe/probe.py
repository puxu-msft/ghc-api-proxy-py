...
Run by hand, never by the test suite: it needs credentials and it makes real calls.
    ...
    PYTHONPATH=src uv run python .dev/exp/260820-websearch-probe/probe.py A
    PYTHONPATH=src uv run python .dev/exp/260820-websearch-probe/probe.py B
    PYTHONPATH=src uv run python .dev/exp/260820-websearch-probe/probe.py C
